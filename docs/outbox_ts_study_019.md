...
![outbox_ts_study_019_quarantine_concept.png](./picture/outbox_ts_study_019_quarantine_concept.png)
...
![outbox_ts_study_019_poison_loop.png](./picture/outbox_ts_study_019_poison_loop.png)
...
```mermaid
flowchart TD
    Try[リトライ試行] -- 回数上限超え/致命的エラー --> Dead[Dead Letterへ隔離📮]
    Dead --> Human[人間が調査・修正🛠️]
    Human -- 修正完了 --> Requeue[再投入/再送🔁]
    Human -- 不要/修正不能 --> Drop[廃棄🗑️]
```

![dead letter](./picture/outbox_ts_study_019_dead_letter.png)
ポイントはこれ👇
**「一時的にダメ」なのか「構造的にダメ」なのかを分ける**🧠✨

### A) だいたいリトライで直る（＝一時的エラー）🌧️🔁
![outbox_ts_study_019_error_classification.png](./picture/outbox_ts_study_019_error_classification.png)
...
![outbox_ts_study_019_design_options.png](./picture/outbox_ts_study_019_design_options.png)
...
![outbox_ts_study_019_evidence_bag.png](./picture/outbox_ts_study_019_evidence_bag.png)
...
![outbox_ts_study_019_recovery_strategies.png](./picture/outbox_ts_study_019_recovery_strategies.png)
...
![outbox_ts_study_019_dashboard_view.png](./picture/outbox_ts_study_019_dashboard_view.png)
