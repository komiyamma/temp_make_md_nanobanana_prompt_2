...
![第19章失敗結果も保存する冪等__エラー保存戦略](./picture/idem_ts_study_019_第19章失敗結果も保存する冪等__エラー保存戦略.png)
...
![2_失敗結果を保存するメリット](./picture/idem_ts_study_019_2_失敗結果を保存するメリット.png)
...
![3_失敗結果を保存しないメリット](./picture/idem_ts_study_019_3_失敗結果を保存しないメリット.png)
...
![5_ざっくり早見表ミニ注文api想定](./picture/idem_ts_study_019_5_ざっくり早見表ミニ注文api想定.png)
...
![7_ミニ注文apiエラー保存つき_冪等ストア_実装方針a](./picture/idem_ts_study_019_7_ミニ注文apiエラー保存つき_冪等ストア_実装方針a.png)
...
![8_方針aの注意点ここだけは押さえてね](./picture/idem_ts_study_019_8_方針aの注意点ここだけは押さえてね.png)
...
![10_ai活用判断力を爆上げするプロンプト集](./picture/idem_ts_study_019_10_ai活用判断力を爆上げするプロンプト集.png)
