...
![Tech vs Business Timeout](./picture/saga_cs_study_017_timeout_types.png)
...
![Deadline Data Fields](./picture/saga_cs_study_017_deadline_data.png)
...
![Human Intervention Handover](./picture/saga_cs_study_017_human_intervention.png)
...
![Admin Control Panel Buttons](./picture/saga_cs_study_017_admin_panel.png)
...
![Timeout State Flow](./picture/saga_cs_study_017_timeout_state_flow.png)
```mermaid
stateDiagram-v2
    [*] --> PendingPayment
...
![Timeout Worker Scanner](./picture/saga_cs_study_017_timeout_worker.png)
...
![Timeout Exercise Checklist](./picture/saga_cs_study_017_timeout_exercise.png)
