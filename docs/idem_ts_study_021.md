...
![第21章非同期の世界は重複配送が普通キュー入門](./picture/idem_ts_study_021_ch21_async_world_duplicate_delivery_is_normal_queue_intro.png)
...
![Concept](./picture/idem_ts_study_021_at_least_once.png)
...
![213_少なくとも1回配送atleastonceって](./picture/idem_ts_study_021_213_at_least_once_delivery.png)
...
![ACK Failure and Message Retry](./picture/idem_ts_study_021_ack_retry.png)
...
![パターンb可視性タイムアウトvisibility_timeout切れ](./picture/idem_ts_study_021_pattern_b_visibility_timeout_expired.png)
...
![217_重複配送でも壊れない処理の条件](./picture/idem_ts_study_021_217_conditions_for_process_safe_against_duplicate_delivery.png)
...
![条件3記録と副作用の順番をミスらない](./picture/idem_ts_study_021_condition3_do_not_mess_up_order_of_recording_and_side_effects.png)
...
![③_consumer本体重複なら即return](./picture/idem_ts_study_021_3_consumer_body_return_immediately_if_duplicate.png)
...
![演習1次の処理重複したら何が起きる](./picture/idem_ts_study_021_exercise1_what_happens_if_next_process_duplicates.png)
