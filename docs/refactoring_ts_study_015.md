...
![Safety Routine Cycle](./picture/refactoring_ts_study_015_safety_routine.png)
...
### Step 1：変更は小さく👣
![Small Commit Box](./picture/refactoring_ts_study_015_one_commit.png)
...
![NPM Scripts Menu](./picture/refactoring_ts_study_015_npm_scripts.png)
...
![VS Code Tasks Button](./picture/refactoring_ts_study_015_vscode_tasks.png)
...
## 5) 時間別メニュー（今日はどれ回す？）⏱️🧁
![Time Based Menu](./picture/refactoring_ts_study_015_time_menu.png)
...
### ③ diffが怪しい👀⚠️
![Diff Check Eyes](./picture/refactoring_ts_study_015_diff_check.png)
...
![Commit Stack](./picture/refactoring_ts_study_015_commit_stack.png)
