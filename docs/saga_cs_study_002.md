...
![Duplicate Messages](./picture/saga_cs_study_002_duplicate_msg.png)

イベントやメッセージの世界は、届け漏れを避けるために **重複受信** が起きやすいんだよ〜💦 ([Microsoft Learn][1])

## ② “順番どおり”は期待しないほうが安全🌀⏱️

![Out of Order Messages](./picture/saga_cs_study_002_out_of_order.png)
...
![Double Charge](./picture/saga_cs_study_002_double_charge.png)
...
![Ghost Transaction](./picture/saga_cs_study_002_ghost_txn.png)
...
![Inventory Leak](./picture/saga_cs_study_002_inventory_leak.png)
...
![Lost Transaction](./picture/saga_cs_study_002_lost_txn.png)
...
![Compensation Failure](./picture/saga_cs_study_002_compensation_fail.png)
