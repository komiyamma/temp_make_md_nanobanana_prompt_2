...
![第23章冪等性テスト2回10回同時実行](./picture/idem_ts_study_023_ch23_idempotency_test_2_times_10_concurrent_executions.png)
...
![Idempotency Testing](./picture/idem_ts_study_023_testing.png)
...
sequenceDiagram
    ...
    T->>A: request (Key: K)
    T->>A: request (Key: K)
    Note over T,A: 同時に 10回 ⚡
    
    A-->>T: 201 Created (ID: 123)
    A-->>T: 201 Created (ID: 123)
    A-->>T: 201 Created (ID: 123)
    
    Note over T: 全部同じリソースなら合格! ✅
```
...
![今どきの道具えらびざっくり結論](./picture/idem_ts_study_023_modern_tool_selection_rough_conclusion.png)
...
![c_エラー時の扱い](./picture/idem_ts_study_023_c_handling_errors.png)
...
![2_api本体express](./picture/idem_ts_study_023_2_api_body_express.png)
...
![ここでのポイント](./picture/idem_ts_study_023_key_points_here.png)
...
![発展①fastcheckプロパティベーステストで_変な入力_を自動生成](./picture/idem_ts_study_023_advanced1_fastcheck_property_based_testing_auto_generate_weird_inputs.png)
...
![1_テスト観点を増やす](./picture/idem_ts_study_023_1_increase_test_perspectives.png)
