...
![observer_cs_study_022_alert_vs_dashboard](./picture/observer_cs_study_022_alert_vs_dashboard.png)
...
![observer_cs_study_022_symptom_focus](./picture/observer_cs_study_022_symptom_focus.png)
...
![画像を挿入予定](./picture/observer_cs_study_022_alert_decision.png)

```mermaid
flowchart TD
    Start([何か起きた！🤯]) --> Q1{"User影響ある？<br>(症状？)"}
    Q1 -- No --> Dashboard[Dashbordで見る 📊]
    Q1 -- Yes --> Q2{"今すぐ対応できる？<br>(Actionable?)"}
    Q2 -- No --> Dashboard
    Q2 -- Yes --> Alert[Alert鳴らす 🚨]
...
![observer_cs_study_022_suitable_metrics](./picture/observer_cs_study_022_suitable_metrics.png)
...
![observer_cs_study_022_unsuitable_metrics](./picture/observer_cs_study_022_unsuitable_metrics.png)
...
![observer_cs_study_022_threshold_window](./picture/observer_cs_study_022_threshold_window.png)
...
![observer_cs_study_022_burn_rate](./picture/observer_cs_study_022_burn_rate.png)
