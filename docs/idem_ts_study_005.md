...
![idem_ts_study_005_plushie_panic.png](./picture/idem_ts_study_005_plushie_panic.png)
...
![idem_ts_study_005_order_card.png](./picture/idem_ts_study_005_order_card.png)
...
![idem_ts_study_005_state_map.png](./picture/idem_ts_study_005_state_map.png)
...
stateDiagram-v2
    [*] --> created: 注文作成
    created --> payment_pending: 支払い処理開始
    payment_pending --> paid: 成功
    payment_pending --> payment_failed: 失敗
    paid --> [*]
    payment_failed --> payment_pending: リトライ
```
...
![idem_ts_study_005_signpost.png](./picture/idem_ts_study_005_signpost.png)
