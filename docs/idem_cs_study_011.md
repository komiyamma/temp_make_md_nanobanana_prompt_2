...
![クライアント発行 vs サーバー発行](./picture/idem_cs_study_011_client_vs_server.png)
...
![2段階サーバー発行フロー](./picture/idem_cs_study_011_two_step_flow.png)
...
![比較表](./picture/idem_cs_study_011_comparison_table.png)
...
![判断フローチャート](./picture/idem_cs_study_011_flowchart_decision.png)
...
![再送の落とし穴](./picture/idem_cs_study_011_pitfalls.png)
